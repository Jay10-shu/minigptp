...
from minigpt4.datasets.datasets.tc_msd_and_tcia import TC_MSD_and_TCIA_Dataset
...
from minigpt4.datasets.datasets.MSD_3d_dataset import ReferMSDPancreas3DDataset

@registry.register_builder("tc_msd_and_tcia")
class COCOCapBuilder(BaseDatasetBuilder):
    train_dataset_cls = TC_MSD_and_TCIA_Dataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/TC_MSD_and_TCIA/default.yaml",
    }
...
class COCOCapBuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/roco/caption.yaml",
    }

@registry.register_builder("rocov2")
class COCOCapBuilder(BaseDatasetBuilder):
    train_dataset_cls = ROCOv2CapTrainDataset
    eval_dataset_cls = ROCOv2CapEvalDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/rocov2/caption.yaml",
    }
...
class COCOCapBuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/vqarad/caption.yaml",
    }
...
class COCOCapBuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/slake/default.yaml",
    }
...
class COCOCapBuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/openi/caption.yaml",
    }
...
class SlakeRefBuilder(AllRefCOCOBuilder):
    train_dataset_cls = ReferSlakeDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/slake/default_ref.yaml",
    }
...
# ==================== 在这里添加下面的代码块 ====================
@registry.register_builder("MSD_pancreas_ref_3d")
class MSDPancreasRef3DBuilder(BaseDatasetBuilder):
    train_dataset_cls = ReferMSDPancreas3DDataset
    DATASET_CONFIG_DICT = {
        "default": "minigpt4/configs/datasets/MSD/default_ref_3d.yaml",
    }  
